...
\titlepage{Hybrid Email Solution Infrastructure with Data Center (DC) And Disaster Recovery (DR)}{ 233207}{Professional Masters in Information Technology}
{Information Technology}{September 2025}
{Dr. Mohammad Shahidul Islam, Professor}
...
\textbf{ADDS}  & Active Directory Domain Services \\
\textbf{DC}  & Domain Controller \\ 
\textbf{DNS}  & Domain Name System \\ 
\textbf{NTP}  & Network Time Protocol \\ 
\textbf{SMTP}  & Simple Mail Transfer Protocol \\ 
\textbf{MAPI}  & Messaging Application Programming Interface \\ 
\textbf{OWA}  & Outlook Web Access \\ 
\textbf{EWS}  & Exchange Web Services \\ 
\textbf{ECP}  & Exchange Control Panel \\ 
\textbf{EAS}  & Exchange ActiveSync \\ 
\textbf{LDAP}  & Lightweight Directory Access Protocol \\ 
\textbf{SSO}  & Single Sign-On \\ 
\textbf{FQDN}  & Fully Qualified Domain Name \\ 
\textbf{EMS}  & Exchange Management Shell \\ 
\textbf{CAS}  & Client Access Server \\ 
\textbf{MBX}  & Mailbox Server \\ 
\textbf{DAG}  & Database Availability Group \\ 
\textbf{HCW}  & Hybrid Configuration Wizard \\ 
\textbf{IMAP}  & Internet Message Access Protocol \\ 
\textbf{EXO}  & Exchange Online \\ 
...
\input{Chap6/Chapter6.tex}
% \label{chap:Deployment Prerequisites}
% \input{Chap6/Chapter6}

%\chapter{Bill of materials}
\input{Chap7/Chapter7.tex}
% \label{chap:Bill of materials}
% \input{Chap7/Chapter7}
%\chapter{Bill of materials}

\input{Chap8/Chapter8.tex}
